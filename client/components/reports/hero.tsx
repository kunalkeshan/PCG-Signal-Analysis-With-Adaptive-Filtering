...
const Hero = () => {
	const subtitles = [
		"Our PCG Signal Analysis project aims to improve the quality of heart sound recordings using advanced digital signal processing techniques. By applying adaptive filtering algorithms, we're working to reduce noise and enhance the clarity of phonocardiogram signals. Project reports, including PDFs, presentations, and other related documents, are available here.",
	];
